...
export default function Uploader({
  projectId,
  onLayerAdded, // 👈 callback para actualizar frontend
  onError,
}: {
  projectId: string
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        disabled={uploading}
        className="w-full sm:w-auto px-3 sm:px-4 py-2 text-xs sm:text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium shadow disabled:opacity-60 transition"
      >
